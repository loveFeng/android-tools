...
ECHO=echo
# Try to find busybox
if /data/data/com.googlecode.droidwall/app_bin/busybox_g1 --help >/dev/null 2>/dev/null ; then
	BUSYBOX=/data/data/com.googlecode.droidwall/app_bin/busybox_g1
	GREP="$BUSYBOX grep"
	ECHO="$BUSYBOX echo"
...
if /data/data/com.googlecode.droidwall/app_bin/iptables_armv5 --version >/dev/null 2>/dev/null ; then
	IPTABLES=/data/data/com.googlecode.droidwall/app_bin/iptables_armv5
fi
...
$IPTABLES -A droidwall-3g -m owner --uid-owner 1000 -j RETURN || exit
